...
// after the last word(the number may be zero), and between words(at least one between any pair of neighbouring words), and 
...
function songDecoder(song) {
  return song.replace(/^(WUB)*|((WUB)*$)/g, '').replace(/(WUB)+/g, ' ');
}
