...
// when this number has at most 2 digits because you are supposed to know if a number of at most 2 
...
function operation(num) {
  ...
  let otherDigits = (num - lastDigit) / 10;
  return otherDigits - (2 * lastDigit);
}
